...
数据集**FloodMulS**用于训练**SLIP-Flood**中的**FICM**模块。可通过[下载链接-kaggle](https://www.kaggle.com/datasets/muhantang/floodmuls-and-floodit/data) [下载链接-hugging face](https://huggingface.co/datasets/muhan-yy/FloodMulS)获取。
...
数据集**FloodIT**用于训练**SLIP-Flood**中的**FTIRM**模块。可通过[下载链接-kaggle](https://www.kaggle.com/datasets/muhantang/floodmuls-and-floodit/data) [下载链接-hugging face](https://huggingface.co/datasets/muhan-yy/FloodIT)获取。
